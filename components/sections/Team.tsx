...
const MEMBERS = [
  {
    ...
    role: "高校時代に独学でプログラミングを開始。リクルートでテックリードとして新規事業開発や強化学習の導入を主導した後、HRテック・スタートアップにCTOとして参画しエグジットに貢献。その後は独立し当社創業の礎となる開発事業を立ち上げた。サイバー攻撃と防御の国際資格「ホワイトハッカー」を保有。",
  ...
  },
  {
    ...
    role: "三井物産で金融事業を経験後、HRテック・スタートアップにCOOとして参画。プロダクトマネジメントからセールス・マーケティング、資金調達、組織づくりまで経営全般を管掌しエグジットに貢献。その後はスタートアップやベンチャーキャピタルへのハンズオン支援に従事。東京大学卒業・同大学院修了（物理工学）。",
    expertise: ["元三井物産", "スタートアップ経営", "COO経験者"],
  },
];
